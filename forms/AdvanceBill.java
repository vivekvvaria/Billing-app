...
public class AdvanceBill extends javax.swing.JFrame {
    Connection con;
    ...
    private void initComponents() {
        ...
        bill.setBackground(new java.awt.Color(51, 255, 255));
    ...
    public void billSeq(){
        try{
            ...
            String sql="SELECT bill_no,date,company,mobilenumber,bankname,accountnumber,receivername,sendername,amount,commission,grandtotal,username FROM inward WHERE bill_no="+b_num+";";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdvanceBill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdvanceBill().setVisible(true);
            }
        });
    }
